...
const DataTable = ({
  ...
  useEffect(() => setPageSize(defaultValue || 2), [defaultValue]);
  ...
  return (
    <TableContainer sx={{ boxShadow: "none" }}>
            ...
            <MDBox display="flex" alignItems="center">
              <Autocomplete
                ...
                onChange={(event, newValue) => {
                  setEntriesPerPage(parseInt(newValue, 2));
                }}
                size="small"
                sx={{ width: "5rem" }}
      ...
      <Table {...getTableProps()}>
        <MDBox
          component="thead"
          sx={{ color: "#3f3f46", backgroundColor: "#3f3f46" }}
        >
...
DataTable.defaultProps = {
  entriesPerPage: { defaultValue: 2, entries: [2, 5, 10, 15, 20, 25] },
  canSearch: false,
